...
const ArtistDetailsClient: React.FC<ArtistDetailsClientProps> = ({ artistName, songs }) => {
    ...
    const isSameContext = player.playContext === 'artist' && player.playContextId === artistName;
